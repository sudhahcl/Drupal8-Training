 ...
 *
 * @package Drupal\custom_user\Form
 */
class ContentUserForm extends FormBase {
  ...
  //   return new static(
  //       $container->get('custom_user.settings')
  //   );
  // }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = \Drupal::config('custom_user.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    //$config = \Drupal::config('custom_user.settings')->getEditable();
    $config = \Drupal::service('config.factory')->getEditable('custom_user.settings');
